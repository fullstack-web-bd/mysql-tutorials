...
--
-- Host: localhost:8889
-- Generation Time: Jul 16, 2022 at 05:22 PM
...
INSERT INTO `employee` (`id`, `department_id`, `manager_id`, `name`, `email`, `salary`) VALUES
(1, 1, NULL, 'Rony - M', 'rony@gmail.com', 100),
(2, 3, NULL, 'Akash - E', 'akash@gmail.com', 200),
(3, 1, 1, 'Polash - D', 'polash@gmail.com', 300),
(4, 1, 2, 'Jahangir', 'jahangir@gmail.com', 150),
(6, NULL, NULL, 'Anik', 'vcvcv', 5),
(7, NULL, NULL, 'AkashNew', 'dfdf', 10);
...
--
ALTER TABLE `employee`
  ADD CONSTRAINT `employee_ibfk_1` FOREIGN KEY (`department_id`) REFERENCES `departments` (`id`);
COMMIT;
